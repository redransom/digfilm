        ...
        <div class="module-body">
                ...
                {!! Form::open(array('route' => 'rulesets.store', 'class'=>'form-horizontal row-fluid')) !!}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {!! Form::select('league_type', ["U"=>"Public", "R" => "Private"], null, ['class'=>'span2']) !!}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {!! Form::text('ind_film_countdown', null, ['class'=>'span2', 'placeholder'=>'Enter film countdown here...']) !!}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {!! Form::text('auction_timeout', null, ['class'=>'span2', 'placeholder'=>'Leave empty if no expiry on auctions']) !!}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {!! Form::text('auction_movie_release', null, ['class'=>'span2']) !!}
